...
parsed_doc <- read_html("https://google.com") # usually the first step in R when scraping web pages
parsed_doc
...
as_list(parsed_doc)
## --> not very helpful - better use the browser/web inspector tools to inspect HTML and engineer XPath expressions
